...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210723/5b877233572742ac8ed59030148f2063.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="huiyuanhao" placeholder="会员号" class="form-control-i">
							</div>
							<div class="form-group">
