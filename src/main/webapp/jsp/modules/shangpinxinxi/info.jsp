						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="baoxiuqi" name="baoxiuqi" class="form-control" v-model="ruleForm.baoxiuqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>上架日期</label>
									...
									<div class="form-group  col-md-12">
										<label>器材介绍</label>
										<script id="qicaijieshaoEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.qicaijieshao != null && ruleForm.qicaijieshao != 'null' && ruleForm.qicaijieshao != ''){
				var mes = '' + ruleForm.qicaijieshao;
				var qicaijieshaoUeditor = UE.getEditor('qicaijieshaoEditor');
				qicaijieshaoUeditor.ready(function() {
					qicaijieshaoUeditor.setContent(mes);
					qicaijieshaoUeditor.setDisabled('fullscreen');
				});
			}
		}  
