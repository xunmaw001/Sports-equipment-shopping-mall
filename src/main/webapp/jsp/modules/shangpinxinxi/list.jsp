...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('baoxiuqi')">保修期<i id="baoxiuqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var baoxiuqiCell  = document.createElement('td');

						 baoxiuqiCell.innerHTML = item.baoxiuqi;

			row.appendChild(baoxiuqiCell);
			...
			var qicaijieshaoCell  = document.createElement('td');
