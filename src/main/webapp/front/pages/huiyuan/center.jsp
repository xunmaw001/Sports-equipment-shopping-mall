				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">会员号</label>
							<div class="layui-input-block input">
								<input type="text" readonly="readonly" name="huiyuanhao" name="huiyuanhao" id="huiyuanhao" placeholder="会员号" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							...
							<div class="layui-input-block">
								<img id="touxiangImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"none","borderColor":"#DCDFE6","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"none","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(255, 204, 0, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="touxiangUpload">
