...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"20px 0 10px 0","boxShadow":"8px 8px 1px #009999","margin":"10px auto","borderColor":"rgba(255, 204, 0, 1)","backgroundColor":"rgba(255, 204, 0, 1)","color":"rgba(0, 51, 102, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0 0 0 10px","fontSize":"16px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>商城公告</span>
			</div>
			<!-- 标题 -->
