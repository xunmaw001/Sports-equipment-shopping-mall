			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.baoxiuqi" type="text" :readonly="ro.baoxiuqi" name="baoxiuqi" id="baoxiuqi" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">器材介绍：</label>
						<div class="layui-input-block">
							<textarea name="qicaijieshao" id="qicaijieshao">请输入器材介绍</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					var qicaijieshao = tinymce.get('#qicaijieshao').getContent()
					data.qicaijieshao = qicaijieshao;
