			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid"}'>
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}' class="layui-form-item layui-form-text">
						...
						<div :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}' class="layui-form-item layui-form-text l-redio">
						...
						<div class="layui-form-item">
							<div class="layui-input-block"  style="display: flex;flex-wrap:wrap;">
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto 0","borderColor":"#ccc","backgroundColor":"rgba(0, 153, 153, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">添加</button>
								<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto","borderColor":"#ccc","backgroundColor":"rgba(0, 153, 153, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
							</div>
						</div>
					</form>
				</div>
